                ...
                <div class="row g-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" class="form-control @error('mother_name') is-invalid @enderror"
                                    id="mother_name" autocomplete="off" wire:model.blur="mother_name"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="date" class="form-control @error('date_dr_number') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" class="form-control @error('number_car') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select class="form-control @error('typecar') is-invalid @enderror" id="typecar"
                                    wire:model.blur="typecar">
                                    <option value="">— هەڵبژێرە —</option>
